...
| Operations security | Runbooks, lifecycle controls, escalation | `docs/runbooks/*.md`, `docs/lifecycle-controls.md`, `docs/support-escalation-path.md`, `docs/operations-guide.md` |
...
| Incident management | IR policy, SLAs, playbooks | `docs/policies/incident-response-policy.md`, `docs/sla.md`, `docs/runbooks/*.md` |
...
- SOC 2–style design matrix: `docs/compliance/controls-matrix.md`
