...
| CC-04 | Availability / integrity | Detect and triage replay and drift failures | Runbooks under `docs/runbooks/`; incident tickets; replay and drift artifacts | Continuous | SRE |
...
- ISO 27001 Annex A mapping (non-certified): `docs/compliance/iso27001-annex-a-mapping.md`
