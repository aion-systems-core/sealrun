...
- **Markdown specs stubs:** removed; use [OS contract spec](../os_contract_spec.md), [Architecture](../architecture.md), and [Compliance one-pager](../compliance/sealrun_compliance_onepager.md) as canonical technical references.
