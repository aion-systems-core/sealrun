...
3. Review active governance bundle constraints (`docs/governance/bundles/`) and policy evaluation history.
...
- Document final disposition (accept, reject, escalate) in `docs/templates/audit-evidence-drift-template.md`.
- Record governance decision using `docs/templates/audit-evidence-governance-decision-template.md` when policy posture changes.
