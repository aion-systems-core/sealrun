...
- Confirm tenant isolation was not violated during the incident window (`docs/runbooks/incident-tenant-isolation-breach-attempt.md`).
...
- Update monitoring for early detection of index inconsistencies; archive findings with `docs/templates/audit-evidence-replay-template.md` where replay was used to validate recovery.
